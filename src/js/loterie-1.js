...
export const lotsOBJ = {
  ...
  lot: [
    { label: "100", description:"Vous avez gagné 100pts", quantite : 6 , couleur: "#5078ff", gain:1 },
    { label: "200", description:"Vous avez gagné 200pts : pas mal !", quantite : 3 , couleur: "#6262be", gain:1 },
    { label: "-500", description:"Vous avez perdu 500pts : pas de chance ! ", quantite : 2 , couleur: "#cc26a0", gain:1 },
    { label: "1000", description:"Vous avez gagné 1000pts : fantastique !", quantite : 1 , couleur: "#ff0000", gain:1 }
    ]
  };
